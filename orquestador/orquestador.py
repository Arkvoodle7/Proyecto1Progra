...
from ValidadorInscripcion import ValidadorInscripcion  
from GestorInscripcion import GestorInscripcion  

# URI de MongoDB
mongo_uri = "mongodb://localhost:27017" 

# Instancias del validador y gestor
validador = ValidadorInscripcion()
gestor = GestorInscripcion(mongo_uri)
...
def manejar_cliente(cliente_socket):
    try:
        ...
        if root.tag == "inscripcion":
            ...
            # Proceder a desinscribir
            respuesta = gestor.desinscribir_telefono(cuenta, identificacion, telefono)
            cliente_socket.sendall(respuesta.encode('utf-8'))
