...
=======
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <button type="button" class="btn btn-primary w-100" onclick="validarFormulario();">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="btnConfirmar" CssClass="btn btn-primary" runat="server" Text="Si" OnClick="btnConfirmar_Click" />
                </div>
            </div>
        </div>
    </div>
