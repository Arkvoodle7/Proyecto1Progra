...
{
    public class DesinscripcionServiceClient
    {
        private readonly string serviceUrl = "http://localhost:8087/api/unregister";

        public async Task<DesinscripcionResponseDto> UnregisterUserAsync(DesinscripcionRequestDto request)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                return DeserializeFromXml<DesinscripcionResponseDto>(responseContent);
            }
        }
    ...
    // DTOs
    [XmlRoot("DesinscripcionRequestDto")]
    ...
    [XmlRoot("DesinscripcionResponseDto")]
