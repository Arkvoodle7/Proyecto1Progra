<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarAdmin.aspx.cs" Inherits="WebAdministracion.Paginas.EditarAdmin" %>
...
<body>
    <form id="frm_editarAdmin" runat="server">
        <div>
            ...
            <div id="botones" style="text-align: center;">
                ...
                <asp:Button ID="btn_regresar" Text="Regresar" runat="server" OnClick="btnRegresar_Click" CssClass="btn-regresar" />
            </div>

            <div>
                <asp:Label ID="lblMensaje" runat="server" CssClass="text-danger"></asp:Label>
                <asp:Label ID="lblNombreUsuario" runat="server" Text="" />
            </div>
        </div>
    </form>
</body>
