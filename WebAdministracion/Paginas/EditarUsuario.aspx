<%@ Page Title="Edicion de Usuarios" Language="C#" MasterPageFile="~/Paginas/Pagina.Master" AutoEventWireup="true" CodeBehind="EditarUsuario.aspx.cs" Inherits="WebAdministracion.Paginas.EditarUsuario" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container mt-5">
        <h2 class="mb-4 text-center">Edicion de Usuarios</h2>
        ...
        <div>
                ...
                <asp:TextBox ID="txtIdentificacion" runat="server" CssClass="form-control" ReadOnly="true" />
                </div>
