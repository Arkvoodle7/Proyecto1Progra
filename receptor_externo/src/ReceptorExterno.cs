...
class ReceptorExterno
{
    static void Main(string[] args)
    {
        ...
        server.Start();
        Console.WriteLine($"Socket Receptor externo corriendo en {ipReceptorExterno}:{portReceptorExterno}");
    ...
    static void Enviar(string ipExterno, int puertoExterno, string trama)
    {
        TcpClient client = new TcpClient(ipExterno, puertoExterno);
        NetworkStream stream = client.GetStream();
